...
.mcq p[id$="-feedback"] { margin-top:0.5rem; font-weight:600; }
</style>
...
<div class="mcq">
<p><strong>Question ST-P1: Which operation is most directly responsible for converting an axis direction and position vector into the moment part of a screw?</strong></p>
<form id="q-st-p1">
  ...
  <button type="button"
    onclick="checkMCQ('q-st-p1', 'b',
      'Correct. The moment part of a line or revolute screw comes from a cross product with the axis direction.',
      'Incorrect. Correct answer: (b). The cross product encodes the moment generated by an axis location and direction.')">
    Check Answer
  </button>
...
<div class="mcq">
<p><strong>Question ST-P2: Why is linear dependence important before studying singularities?</strong></p>
<form id="q-st-p2">
  <input type="radio" name="q-st-p2" value="a"> It tells us whether several screw directions span fewer independent instantaneous motions than expected.<br>
  <input type="radio" name="q-st-p2" value="b"> It guarantees that every rotation matrix has determinant zero.<br>
  <input type="radio" name="q-st-p2" value="c"> It removes the need to choose reference frames.<br>
  <input type="radio" name="q-st-p2" value="d"> It converts all prismatic joints into revolute joints.<br>
  <button type="button"
    onclick="checkMCQ('q-st-p2', 'a',
      'Correct. A rank drop is exactly a loss of independent screw directions.',
      'Incorrect. Correct answer: (a). Singularities are read from the independence of Jacobian screw columns.')">
    Check Answer
  </button>
...
<div class="mcq">
<p><strong>Question ST-M1: What is the main geometric idea behind screw theory?</strong></p>
<form id="q-st-m1">
...
<div class="mcq">
<p><strong>Question ST-M2: In the POE formula, what does each exponential factor represent?</strong></p>
<form id="q-st-m2">
...
<div class="mcq">
<p><strong>Question ST-N1: In this chapter, what does the suffix in $\mathcal{T}^S$ indicate?</strong></p>
<form id="q-st-n1">
...
<div class="mcq">
<p><strong>Question ST-N2: What is the reciprocal product $\mathcal{W}\odot\mathcal{T}$ used to encode for a wrench and a twist?</strong></p>
<form id="q-st-n2">
...
<div class="mcq">
<p><strong>Question ST-R1: What does the skew-symmetric matrix $\tilde{\mathbf{n}}$ do to a vector $\mathbf{a}$?</strong></p>
<form id="q-st-r1">
...
<div class="mcq">
<p><strong>Question ST-R2: Why does $\frac{d\mathbf{R}}{d\phi}=\tilde{\mathbf{n}}\mathbf{R}$ lead naturally to an exponential?</strong></p>
<form id="q-st-r2">
...
<div class="mcq">
<p><strong>Question ST-E1: In $\exp(\phi\tilde{\mathbf{n}})$, what is the role of $\phi$?</strong></p>
<form id="q-st-e1">
...
<div class="mcq">
<p><strong>Question ST-E2: What does the Euler-Rodrigues formula provide?</strong></p>
<form id="q-st-e2">
...
<div class="mcq">
<p><strong>Question ST-T1: What is stored in the twist $\mathcal{T}=\begin{bmatrix}\boldsymbol{\omega}\\ \mathbf{v}\end{bmatrix}$?</strong></p>
<form id="q-st-t1">
...
<div class="mcq">
<p><strong>Question ST-T2: How are spatial and body-fixed twist coordinates related?</strong></p>
<form id="q-st-t2">
...
<div class="mcq">
<p><strong>Question ST-B1: What does the body Jacobian map joint rates to?</strong></p>
<form id="q-st-b1">
...
<div class="mcq">
<p><strong>Question ST-D1: In the interactive sketch, what does dragging the line itself primarily change?</strong></p>
<form id="q-st-d1">
...
<div class="mcq">
<p><strong>Question ST-D2: Why does the readout update $\mathbf{m}_O$ when the line moves?</strong></p>
<form id="q-st-d2">
